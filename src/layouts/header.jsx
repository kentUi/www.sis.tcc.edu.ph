...
function LayoutTop() {
    ...
    return (
        <>
            ...
            <div className="nk-header nk-header-fixed is-light" style={{ borderTop: '10px solid #b4543d' }}>
                            ...
                            <ul className="nk-quick-nav">
                                <li className="dropdown chats-dropdown hide-mb-xs">
                                    <a href="#" className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                        <div className="icon-status  icon-status-danger"><em className="icon ni ni-comments"></em></div>
                                    </a>
                                ...
                                <li className="dropdown notification-dropdown">
                                    <a href="#" className="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                                        <div className="icon-status icon-status-danger"><em className="icon ni ni-bell"></em></div>
                                    </a>
                                    <div className="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                        <div className="dropdown-head">
                                ...
                                <li className="dropdown user-dropdown">
                                    <a href="#" className="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                                        <div className="user-toggle">
                                            <div className="user-avatar sm" style={{ backgroundColor: '#b4543d' }}>
                                            <img src="/user.png" />
                                            </div>
                                            <div className="user-info d-none d-xl-block">

                                                <div className="user-status user-status-active" style={{ color: '#b4543d' }}>
                                                    Account Financer
                                                </div>
                                                <div className="user-name dropdown-indicator" style={{ textTransform: 'uppercase' }}>
                                                    x
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                            <div className="user-card">
                                                ...
                                                <div className="user-info">
                                                    <span className="lead-text">x</span>
                                                    <span className="sub-text">x</span>
                                                </div>
                                            </div>
                                        </div>
