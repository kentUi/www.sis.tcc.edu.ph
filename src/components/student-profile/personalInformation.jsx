...
function PerosnalInfoProfileComponents() {
                    ...
                    <div className="nk-block-head nk-block-head-lg pb-4">
                        <div className="nk-block-between">
                            <div className="nk-block-head-content">
                                <h4 className="nk-block-title mb-0 ">Personal Information</h4>
                            </div>
                        ...
                        <div className="nk-data data-list">
                            ...
                            <div className="data-item p-2">
                                <div className="data-col">
                                    ...
                                    {detail ? (
                                        <span className="data-value" style={{ letterSpacing: '2px' }}>+(63) {detail.info_mobile}</span>
                                    ) : (
                                        <i><img src="/loading.gif" height="32" /> Please wait...</i>
                                    )}
                                </div>
                            ...
                            <div className="data-item p-2">
                                <div className="data-col">
                                    ...
                                    {detail ? (
                                        <span className="data-value text-soft">{detail.info_email}</span>
                                    ) : (
                                        <i><img src="/loading.gif" height="32" /> Please wait...</i>
                                    )}
                                </div>
                            ...
                            <div className="data-item p-2" data-bs-toggle="modal" data-bs-target="#profile-edit">
                                <div className="data-col">
                                    ...
                                    {detail ? (
                                        <span className="data-value">{detail.info_birthday}</span>
                                    ) : (
                                        <i><img src="/loading.gif" height="32" /> Please wait...</i>
                                    )}
                                </div>
                            ...
                            <div className="data-item p-2" data-bs-toggle="modal" data-bs-target="#profile-edit">
                                <div className="data-col">
                                    ...
                                    {detail ? (
                                        <span className="data-value">{detail.info_placeofbirth}</span>
                                    ) : (
                                        <i><img src="/loading.gif" height="32" /> Please wait...</i>
                                    )}
                                </div>
                            ...
                            <div className="data-item p-2" data-bs-toggle="modal" data-bs-target="#profile-edit" data-tab-target="#address">
                                <div className="data-col">
                                    <span className="data-label">Complete Address</span>
                                    {detail ? (
                                        <span className="data-value">{detail.info_placeofbirth}</span>
                                    ) : (
                                        <i><img src="/loading.gif" height="32" /> Please wait...</i>
                    ...
                    <div className="card-inner-group" data-simplebar>
                        ...
                        <div className="card-inner p-0">
                            <ul className="link-list-menu">
                                <li><a className="active" href="html/user-profile-regular.html"><em className="icon ni ni-user-fill-c"></em><span>Personal Infomation</span></a></li>
                                <li><a href="html/user-profile-notification.html"><em className="icon ni ni-users-fill"></em><span>Family Background</span></a></li>
                                <li><a href="html/user-profile-notification.html"><em className="icon ni ni-home-fill"></em><span>Educational Background</span></a></li>
                                <li><a href="html/user-profile-notification.html"><em className="icon ni ni-user-fill"></em><span>Additional Information</span></a></li>
...
export default PerosnalInfoProfileComponents;
