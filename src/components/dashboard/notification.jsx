...
import NotifyDashboardComponents from './components/notify'

function DashboardNotificationComponents() {
                        ...
                        <div className="card-aside-wrap">
                            <div className="card-content">
                                <ul className="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                    ...
                                    <li className="nav-item">
                                        <Link to='/dashboard/notification' className="nav-link active" href="#"><em className="icon ni ni-bell"></em><span>Notifications</span> <span className="badge bg-danger">2</span></Link>
                                    </li>
                                    <li className="nav-item">
...
export default DashboardNotificationComponents;
