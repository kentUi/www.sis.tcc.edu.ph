...
import FinanceDashboardComponents from './components/finances'

function DashboardFinanceComponents() {
                        ...
                        <div className="card-aside-wrap">
                            <div className="card-content">
                                <ul className="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                    ...
                                    <li className="nav-item">
                                        <Link to='/dashboard/finance' className="nav-link active" href="#"><em className="icon ni ni-money"></em><span>Financial Records</span></Link>
                                    </li>
                                    <li className="nav-item">
...
export default DashboardFinanceComponents;
